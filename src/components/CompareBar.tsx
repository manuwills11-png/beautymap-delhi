  ...
  return (
    ...
    >
      <div className="px-4 pb-4">
        ...
        <div
          className={`max-w-lg mx-auto flex items-center gap-3 bg-oxblood-800 text-cream rounded-2xl px-5 py-3.5 transition-all duration-250 ease-out shadow-[0_8px_40px_rgba(126,31,56,0.55)] ${
